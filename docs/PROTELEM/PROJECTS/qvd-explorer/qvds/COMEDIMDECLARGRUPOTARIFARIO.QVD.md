...
# 📦 COMEDIMDECLARGRUPOTARIFARIO.QVD
...
|---|---|---|
| `GRUPO_TARIFARIO_DESCRIPCION` | text | Residencial · General · Grandes Consumos · Cooperativas · Gobierno y Usr.Especiales |
| `ID_GRUPO_TARIFARIO` | integer | 1 · 2 · 3 · 4 · 5 |
