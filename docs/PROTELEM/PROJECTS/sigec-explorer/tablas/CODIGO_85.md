...
| `C85_FECHA_CARGA` | DATE | YES |  |  |
| `C85_REC_ORI_COBRO` | VARCHAR2 | YES |  |  |
| `C85_REC_FEC_COBRO` | DATE | YES |  |  |
| `C85_OBSERVACIONES` | VARCHAR2 | YES |  |  |
| `C85_CANT_RECHAZOS` | NUMBER | YES |  |  |
