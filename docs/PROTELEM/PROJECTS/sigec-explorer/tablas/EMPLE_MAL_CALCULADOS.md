...
| `TAB_NUMERO_PT` | NUMBER | NO |  |  |
| `TCL_CODIGO_PT` | VARCHAR2 | NO |  |  |
| `CLA_CODIGO_PT` | VARCHAR2 | NO |  |  |
| `TEN_CODIGO_PT` | VARCHAR2 | NO |  |  |
| `TAB_FECHA_VIGENCIA_PT` | DATE | NO |  |  |
| `TAB_FECHA_CARGA_PT` | DATE | NO |  |  |
| `TAB_OBSERVACIONES_PT` | VARCHAR2 | YES |  |  |
| `TAB_ESTADO_PT` | VARCHAR2 | NO |  |  |
| `TAB_CONSUMO_LIMITE_PT` | NUMBER | YES |  |  |
| `TCL_CODIGO_ALT_PT` | VARCHAR2 | YES |  |  |
| `TEN_CODIGO_ALT_PT` | VARCHAR2 | YES |  |  |
| `CLA_CODIGO_ALT_PT` | VARCHAR2 | YES |  |  |
| `TCU_GRUPO_ALT_PT` | VARCHAR2 | YES |  |  |
| `TAB_CON_SUBSIDIO_PT` | VARCHAR2 | YES |  |  |
| `TAB_COSTO_MEM_PT` | NUMBER | YES |  |  |
