...
| `DOC_IMPORTE_BASICO_RESID_VAD` | NUMBER | YES |  |  |
| `DOC_IMPORTE_BASICO_SOCIAL_VAD` | NUMBER | YES |  |  |
| `FECHA_REFACTURACION` | DATE | YES |  |  |
| `CANTIDAD_ENE_PROM` | NUMBER | YES |  |  |
| `DOC_IMPORTE_BASICO_RESID_MEM` | NUMBER | YES |  |  |
| `DOC_IMPORTE_BASICO_SOCIAL_MEM` | NUMBER | YES |  |  |
| `PRORRATEO_RESID` | VARCHAR2 | YES |  |  |
| `PRORRATEO_SOCIAL` | VARCHAR2 | YES |  |  |
| `DOC_IMPORTE_SUB_RESID_VAD` | NUMBER | YES |  |  |
| `DOC_IMPORTE_SUB_SOCIAL_VAD` | NUMBER | YES |  |  |
| `DOC_IMPORTE_SUB_RESID_MEM` | NUMBER | YES |  |  |
| `DOC_IMPORTE_SUB_SOCIAL_MEM` | NUMBER | YES |  |  |
| `TCL_CODIGO_RES` | VARCHAR2 | YES |  |  |
| `TCL_CODIGO_SOC` | VARCHAR2 | YES |  |  |
| `CLA_CODIGO_RES_VAD` | VARCHAR2 | YES |  |  |
| `CLA_CODIGO_RES_MEM` | VARCHAR2 | YES |  |  |
| `CLA_CODIGO_SOC_VAD` | VARCHAR2 | YES |  |  |
| `CLA_CODIGO_SOC_MEM` | VARCHAR2 | YES |  |  |
| `DOC_IMPORTE_SUB_SOCIAL_MEM_CONS` | NUMBER | YES |  |  |
| `DOC_IMPORTE_BASICO_SOCIAL_MEM_CONS` | NUMBER | YES |  |  |
| `DOC_IMPORTE_BASICO_RESID_MEM_CONS` | NUMBER | YES |  |  |
| `DOC_IMPORTE_SUB_RESID_MEM_CONS` | NUMBER | YES |  |  |
