...
| `SCF_CODIGO_DOC` | NUMBER | YES |  |  |
| `SCF_DESCRIPCION_DOC` | VARCHAR2 | YES |  |  |
| `SCF_C_POSTAL_DOC` | VARCHAR2 | YES |  |  |
...
| `IVV_DISCRIMINA` | VARCHAR2 | YES |  |  |
| `DOC_IVV_CODIGO` | NUMBER | YES |  |  |
| `CNT_IVV_CODIGO` | NUMBER | YES |  |  |
| `FECHA_LECTURA_MIN` | VARCHAR2 | YES |  |  |
| `FECHA_LECTURA_MAX` | VARCHAR2 | YES |  |  |
...
| `LCT_FECHA_DESDE_HASTA` | VARCHAR2 | YES |  |  |
...
| `CODIGO_BARRA_SS` | VARCHAR2 | YES |  |  |
| `DOC_IMPORTE_SS` | NUMBER | YES |  |  |
| `DOC_RECARGO_VENC_2_SS` | NUMBER | YES |  |  |
| `DOC_RECARGO_VENC_3_SS` | NUMBER | YES |  |  |
| `TIENE_SUBSIDIO` | VARCHAR2 | YES |  |  |
| `MSJ_TEXTO` | VARCHAR2 | YES |  |  |
| `LUGAR_EMISION` | VARCHAR2 | YES |  |  |
| `DOC_TIPO_DESC` | VARCHAR2 | YES |  |  |
| `TIP_DOC` | VARCHAR2 | YES |  |  |
| `NUM_DOC` | VARCHAR2 | YES |  |  |
