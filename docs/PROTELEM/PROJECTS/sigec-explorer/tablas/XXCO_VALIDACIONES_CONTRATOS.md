...
| `VAC_CPP_PRO_ANOANT_TCL_GRL_SCF` | NUMBER | YES |  |  |
| `VAC_PMAA_CONS_MES_ANT_ANT` | NUMBER | YES |  |  |
| `VAC_PMA_CONS_MES_ANT` | NUMBER | YES |  |  |
| `VAC_PAA_CONS_ANIO_ANT` | NUMBER | YES |  |  |
| `VAC_INDICE_DISTORSION` | NUMBER | YES |  |  |
| `VAC_FECHA_PREVISTA_VTO` | DATE | YES |  |  |
| `GRF_CODIGO_ANT` | VARCHAR2 | YES |  |  |
